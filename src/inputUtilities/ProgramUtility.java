...
{
    public static final ProgramUtility instance = new ProgramUtility();
    ...
    public static void parse(String filePath) throws Exception
    {
        ...
        ProgramUtility.instance.InstructionList.put(
                ProgramUtility.instance.instructionCount++, inst);
    ...
    private static void parseInstLine(String line) throws Exception
    {
        ...
        if (line.contains(":"))
        {
            ...
            line = line.trim();
            ProgramUtility.instance.LabelMap.put(loopName.trim(),
                    ProgramUtility.instance.instructionCount);
        }
            ...
            for (int i = 0; i < argListArray.length; i++)
            {
                ...
                if (arg.charAt(0) != 'R' && arg.charAt(0) != 'F')
                {
                    if (arg.charAt(0) < '0' || arg.charAt(0) > '9')
                        if (!ProgramUtility.instance.LabelMap.containsKey(arg))
